 ...
 * @author    Bryan Tran <bryant.business@hotmail.com>
 * @license   GPL-2.0+
 * @link      http://tent.academy.red
 * @copyright 2019 Red Academy
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        http://github.com/lovesongbb
 * Description:       A widget that displays business hours for the Inhabitent Project
 * Version:           1.0.0
 * Author:            Bryan Tran
 * Author URI:        http://github.com/lovesongbb
 * License:           GPL-2.0+
